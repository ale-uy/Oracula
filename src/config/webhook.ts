...
const config = {
  ...
  // En desarrollo usa localhost, en producción usa host.docker.internal o el nombre del servicio
  n8nWebhookUrl: process.env.NEXT_PUBLIC_N8N_WEBHOOK_URL || 
    (isDevelopment ? 'http://localhost:5678' : 'http://host.docker.internal:5678'),
